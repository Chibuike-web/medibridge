...
export default function DownloadPdfButton({ packet }: { packet: TransferPacket }) {
	return (
		<PDFDownloadLink
			...
			className="inline-flex h-9 items-center shrink-0 justify-center rounded-lg bg-gray-900 px-5 text-sm font-medium text-white transition-colors hover:bg-gray-800"
		>
