...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				"group/calendar bg-background p-3 text-sm [--cell-size:2.5rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
			...
			classNames={{
				...
				week: cn("mt-1 flex w-full first:mt-0", defaultClassNames.week),
...
function CalendarDayButton({
	...
	return (
		<Button
			...
			className={cn(
				"flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 text-sm leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-3 group-data-[focused=true]/day:ring-ring/50 data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-end=true]:bg-gray-800 data-[range-end=true]:text-white data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-gray-100 data-[range-middle=true]:text-gray-800 data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md data-[range-start=true]:bg-gray-800 data-[range-start=true]:text-white data-[selected-single=true]:bg-gray-800 data-[selected-single=true]:text-white dark:hover:text-accent-foreground [&>span]:text-xs [&>span]:opacity-70",
				defaultClassNames.day,
				className,
			)}
			{...props}
