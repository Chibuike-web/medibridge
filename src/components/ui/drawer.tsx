...
function DrawerOverlay({
	...
	return (
		<DrawerPrimitive.Overlay
			...
			className={cn(
				"fixed inset-0 z-50 bg-gray-800/50 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0 animation-duration-200 data-[state=closed]:animation-duration-100 ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:animate-none",
				className,
			)}
			{...props}
		/>
