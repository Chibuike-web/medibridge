...
export default function NewTransferRequest() {
	return (
		<main>
			...
			<div className="flex flex-col gap-9 mt-12 max-w-[600px] w-full mx-auto px-6 md:px-0">
				<h1 className="font-semibold text-[24px] text-center mb-6">New Transfer Request</h1>
