		...
		() => [
			{
				...
				cell: ({ row }) => <Checkbox aria-label={`Select ${row.original.name}`} disabled />,
				enableSorting: false,
				size: 40,
			},
			{
			...
			{ header: "Diagnosed At", accessorKey: "diagnosedAt", enableSorting: true },
			{ header: "Last Reviewed", accessorKey: "lastReviewed", enableSorting: true },
			{
				header: "Diagnosis ID",
