...
vi.mock("@/lib/api/get-patient-allergy-details", () => ({ getPatientAllergyDetails: getAllergyDetailsMock }));
vi.mock("@/lib/api/get-patient-diagnosis-details", () => ({ getPatientDiagnosisDetails: getDiagnosisDetailsMock }));
vi.mock("@/lib/api/get-patient-document-details", () => ({ getPatientDocumentDetails: getDocumentDetailsMock }));
vi.mock("@/lib/api/get-patient-immunization-details", () => ({ getPatientImmunizationDetails: getImmunizationDetailsMock }));
vi.mock("@/lib/api/get-patient-medication-details", () => ({ getPatientMedicationDetails: getMedicationDetailsMock }));
vi.mock("@/lib/api/get-patient-procedure-details", () => ({ getPatientProcedureDetails: getProcedureDetailsMock }));
...
describe("Patient records API", () => {
	...
	test("returns allergy details", async () => {
		...
		const response = await getAllergyDetails(new Request("http://localhost/api/patient-allergy-details/allergy-1"), {
	...
	test("returns a 404 null allergy payload when the allergy is missing", async () => {
		...
		const response = await getAllergyDetails(new Request("http://localhost/api/patient-allergy-details/missing"), {
	...
	test("returns diagnosis details", async () => {
		...
		const response = await getDiagnosisDetails(new Request("http://localhost/api/patient-diagnosis-details/diagnosis-1"), {
	...
	test("returns a 404 null diagnosis payload when the diagnosis is missing", async () => {
		...
		const response = await getDiagnosisDetails(new Request("http://localhost/api/patient-diagnosis-details/missing"), {
	...
	test("returns document details", async () => {
		...
		const response = await getDocumentDetails(new Request("http://localhost/api/patient-document-details/document-1"), {
	...
	test("returns a 404 null document payload when the document is missing", async () => {
		...
		const response = await getDocumentDetails(new Request("http://localhost/api/patient-document-details/missing"), {
	...
	test("returns medication details", async () => {
		...
		const response = await getMedicationDetails(new Request("http://localhost/api/patient-medication-details/medication-1"), {
	...
	test("returns a 404 null medication payload when the medication is missing", async () => {
		...
		const response = await getMedicationDetails(new Request("http://localhost/api/patient-medication-details/missing"), {
	...
	test("returns procedure details", async () => {
		...
		const response = await getProcedureDetails(new Request("http://localhost/api/patient-procedure-details/procedure-1"), {
	...
	test("returns a 404 null procedure payload when the procedure is missing", async () => {
		...
		const response = await getProcedureDetails(new Request("http://localhost/api/patient-procedure-details/missing"), {
